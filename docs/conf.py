...
latex_documents = [
  ('index', 'LightMVC.tex', 'LightMVC Documentation',
...
man_pages = [
    ('index', 'lightmvc', 'LightMVC Documentation',
...
texinfo_documents = [
  ('index', 'LightMVC', 'LightMVC Documentation',
   'Foreach Code Factory', 'LightMVC', 'A modular, event-driven, Swoole-enabled PHP framework',
   'Miscellaneous'),
]
