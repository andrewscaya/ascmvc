...
class TestarraylistenersReadModel extends AggregateReadModel
{
    protected $count;
    ...
    public function __invoke(AggregateEvent $event)
    {
        ...
        $aggregateValueObject = new AggregateImmutableValueObject(['testarraylistenersreadmodel' => 'fromarraylistenersreadmodel']);
